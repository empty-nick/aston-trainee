...
const str7 = new Person('John', 25)
console.log(str7.toString()) // return primitive string value "My name is John and I'm 25"
// 2 number
const num1 = 1
...
const num7 = ('str' | 2)
const num8 = ('str' & 2)
const num9 = new Person('Dori', 35)
console.log(num9.valueOf()) //return primitive number value 70
// 3 boolean
const bool1 = true
